...
//   Award, ThumbsUp, ThumbsDown, BarChart3, Microscope
// } from 'lucide-react'
...
//   useEffect(() => {
//     // 1. Fetch Global Stats (A/B Tests, Trends from Opik)
...
//         } : null,
//         // Detailed Agent Breakdown for interactive diagnostics
//         agent_health: {
//           validator: 1.0,
//           scanner: result.scan_metrics ? 1.0 : 0.0,
//           grader: confidence,
//           judge: result.sfia_result?.judge_intervened ? 0.8 : 1.0, // Lower health if judge intervened
...
//     setTimeout(() => setFeedbackState(score === 1 ? 'up' : 'down'), 400)

//     try {
//       await api.submitFeedback(result.job_id, score)
//     } catch (e) {
//       console.error("Feedback failed", e)
//       setFeedbackState('idle') // Reset on error
//     }
//   }
...
//           </div>
//           <div>
//             <div className="text-sm font-medium text-white">Rate This Analysis</div>
//             <div className="text-xs text-text-dim">Feedback directly retrains the Judge Agent</div>
//           </div>
//         </div>
...
//                 className={`px-4 py-2 rounded-md text-xs font-bold border flex items-center gap-2 ${
//                   feedbackState === 'up' 
//                     ? 'bg-green-500/10 border-green-500/50 text-green-400' 
//                     : 'bg-red-500/10 border-red-500/50 text-red-400'
//                 }`}
//               >
//                 {feedbackState === 'up' ? <ThumbsUp className="w-3 h-3" /> : <ThumbsDown className="w-3 h-3" />}
//                 {feedbackState === 'up' ? 'FEEDBACK RECORDED' : 'ISSUE FLAGGED'}
//               </motion.div>
//             )}
//           </AnimatePresence>
//         </div>
...
//       {/* --- LIVE CHARTS (A/B Test & Quality Trend) --- */}
//       {dashboardStats && (
...
//         *If link says "Private Project", ensure you are logged into Comet.com
//       </p>
//     </div>
//   )
// }
...
// function FeedbackButton({ icon, onClick, color, disabled }) {
//   return (
//     <button 
//       onClick={onClick}
//       disabled={disabled}
//       className={`p-2.5 rounded-md bg-black/30 border border-white/10 text-text-dim transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed ${color}`}
//     >
//       {icon}
//     </button>
//   )
...
// function AgentHealthBar({ agent, health, onClick }) {
...
//     <button 
//       onClick={onClick}
//       className="w-full bg-surface hover:bg-white/5 border border-border hover:border-primary/50 rounded-lg p-2 transition-all group text-left"
//     >
//       <div className="flex items-center justify-between mb-2">
//         <span className="text-xs font-mono text-white uppercase group-hover:text-primary transition-colors">{agent}</span>
